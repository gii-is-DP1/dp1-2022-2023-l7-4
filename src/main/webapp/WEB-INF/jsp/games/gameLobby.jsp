...
<petclinic:layout pageName="gameLobby">
	...
	<div class="NewGameMainBody">
		<div class="players">
			...
			<form:form modelAttribute="GameForm" class="GameForm" id="GameForm" action="/games/create">
				<spring:url value="/games/create/add/{userId}" var="addUserUrl">
					<spring:param name="userId" value="" />
				</spring:url> 
						...
						<c:choose>
							<c:when test="${players[1] != null}">
								<img class="playerImg" src="/resources/images/azul.png" />
								 ...
								 <spring:url value="/games/create/remove/{playerNum}"
									var="playerUrl1">
		...
		<div class="bottomButtons">
			<input onClick="gameSubmit()" type="submit" value="Create game">
		</div>
	</div>
